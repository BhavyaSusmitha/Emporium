...
<link rel="stylesheet" href="http://localhost:8055/OnlineEmporium-frontend/resources/css/table.css">
<link rel="stylesheet" href="http://localhost:8055/OnlineEmporium-frontend/resources/css/navbar.css">
<script
...
<nav class="navbar navbar-inverse" id="nav_bar">
   ...
   data-toggle="collapse" data-target="#collapse-example" aria-expanded="false">
		...
		<img src='<c:url value="/resources/images/digil.jpg"></c:url>' alt="NIIT" height="35px" width="130px" align="center"></a>
			</div>
			...
			<ul class="dropdown-menu">
					...
					parameter name is 'searchCondition' -->
					   ...
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Camera"></c:url>'>Camera</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Tab"></c:url>'>Tab</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Pendrive"></c:url>'>Pendrive</a>
					   <a href='<c:url value="/all/searchbycategory?searchCondition=Speakers"></c:url>'>Speakers</a>
